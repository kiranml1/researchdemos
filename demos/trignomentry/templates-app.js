...
angular.module("home/home.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/home.tpl.html",
    "<div class=\"container\">\n" +
    "	<div class=\"col-md-4\">\n" +
    "		<h3>Trignomentry Mathematical Experiment - Kiran Kumar</h3>\n" +
    "		<p>Unit Circle Experiment with Trignomentry Ratios</p>\n" +
    "		<p>SOH CAH TOA</p>\n" +
    "		<p>SOH - Sine - Opposite / Hypotenuse</p>\n" +
    "		<p>CAH - Cosine - Adjacent / Hypotenuse</p>\n" +
    "		<p>TOA - Tangent - Opposite / Adjacent</p>\n" +
    "		<p>Radians >> 360 degrees =  2 * PI * Radians (radius)</p>\n" +
    "		<p> Theta (Angle in Radians ) * Radius = Arc Length</p>\n" +
    "		<p>1 Radian = 180 / PI</p>\n" +
    "		<p>Sum of All angles equal to 180 degrees</p>\n" +
    "		<p>Pythogorous Theorem - AB*AB + BC*BC = CA*CA</p>\n" +
    "		<p>Sin(0) = Cos(90-0) Cos(0) = Sin(90-0)</p>\n" +
    "	</div>\n" +
    "	<unit-circle-trignomentry></unit-circle-trignomentry>\n" +
    "</div>");
}]);
